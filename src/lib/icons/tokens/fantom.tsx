  ...
  <svg xmlns="http://www.w3.org/2000/svg" width={16} viewBox="0 0 32 32">
    <defs>
      <mask id="mask" x="10" y="6" width="93.1" height="20" maskUnits="userSpaceOnUse">
        <g id="a">
          <path className="cls-1" fill="#FFFFFF" fillRule="evenodd" d="M10,6h93.1V26H10Z" />
        </g>
      </mask>
    </defs>
    <title>fa</title>
    <g id="Layer_2" data-name="Layer 2">
      <g id="Layer_1-2" data-name="Layer 1">
        <circle className="cls-2" fill="#13b5ec" cx="16" cy="16" r="16" />
        <g className="cls-3" mask="url(#mask)">
          <path
            fill="#FFFFFF"
            fillRule="evenodd"
            className="cls-1"
