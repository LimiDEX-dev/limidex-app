...
export const PortfolioTable: FC<PortfolioTableProps> = ({
  ...
  <div className="portfolio-table">
    <table className="portfolio-table__main-table">
      ...
      <tbody>
        {activeNetwork === 0 ? trading.map((item, index) => (
          <tr key={`${item.type}-${index}`} className="portfolio-table__row">
            <td>
            ...
            <td>
              <span className="portfolio-table__wrapper">
                <span className="portfolio-table__text">{item.balance}</span>
              </span>
            </td>
            <td>
              <span className="portfolio-table__wrapper">
            ...
            <td>
              <span className="portfolio-table__wrapper">
                <span className="portfolio-table__text">{item.followers}</span>
              </span>
            </td>
            <td>
              <span className="portfolio-table__wrapper">
