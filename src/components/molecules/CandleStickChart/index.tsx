...
export function CandleStickChart(props: any) {
  ...
  function buildChart(data) {
    ...
    const chart = d3.select("#chart").append("svg:svg").attr("class", "chart");
    ...
    chart
      ...
      .attr(
        "height",
        (d: any) => y(min(d.Open, d.Close)) - y(max(d.Open, d.Close)),
      )
    ...
    chart
      ...
      .attr(
        "x1",
        (d: any) =>
          x(d.timestamp) + (0.25 * (width - 2 * margin)) / data.length,
      )
      .attr(
        "x2",
        (d: any) =>
